...
# Define video source (use 0 for webcam)
videoSource = 0
...
# Load YOLO model
net = cv2.dnn.readNet(r"C:\Users\LAVAN\Downloads\coco\yolov3.weights", r"C:\Users\LAVAN\Downloads\coco\yolov3.cfg")

# Load COCO names (class labels)
with open(r"C:\Users\LAVAN\Downloads\coco\coco.names", "r") as f:
